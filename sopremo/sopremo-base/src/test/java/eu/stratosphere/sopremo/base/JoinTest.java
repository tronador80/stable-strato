...
public class JoinTest extends SopremoOperatorTestBase<Join> {
	...
	public void shouldPerformCircularEquiJoinOnThreeInputs1() {
		...
		final AndExpression condition = new AndExpression(
			// new ComparativeExpression(createPath("0", "companyid"), BinaryOperator.EQUAL, createPath("1", "id")),
			new ComparativeExpression(createPath("1", "id"), BinaryOperator.EQUAL, createPath("0", "companyid")),
			new ComparativeExpression(createPath("1", "url"), BinaryOperator.EQUAL, createPath("2", "page")),
			new ComparativeExpression(createPath("0", "id"), BinaryOperator.EQUAL, createPath("2", "adminid")));
		final ObjectCreation transformation = new ObjectCreation();
		transformation.addMapping("name", createPath("0", "name"));
		...
		sopremoPlan.getOutputOperator(0).setInputs(join);
		sopremoPlan.getInput(0).
			addObject("name", "Jon Doe", "id", 1, "companyid", 1).
			addObject("name", "Jane Doe", "id", 2, "companyid", 3).
			addObject("name", "Max Mustermann", "id", 3, "companyid", 2).
			addObject("name", "Irene Mustermann", "id", 4, "companyid", 2);
		sopremoPlan.getInput(1).
			addObject("id", 1, "companyname", "Google", "url", "www.google.com").
			addObject("id", 2, "companyname", "Oracle", "url", "www.oracle.com").
			addObject("id", 3, "companyname", "Sun", "url", "www.sun.com").
			addObject("id", 4, "companyname", "SAP", "url", "www.sap.com");
		sopremoPlan.getInput(2).
			addObject("page", "www.google.com", "adminid", 1).
			addObject("page", "www.oracle.com", "adminid", 3).
			addObject("page", "www.sap.com", "adminid", 5).
			addObject("page", "www.sun.com", "adminid", 2);
		sopremoPlan.getExpectedOutput(0).
			addObject("name", "Jon Doe", "company", "Google", "page", "www.google.com").
	...
	public void shouldFindCircleThroughJoin() {
		...
		final AndExpression condition = new AndExpression(
			new ComparativeExpression(createPath("0", "fk"), BinaryOperator.EQUAL,createPath("1", "k")),
			new ComparativeExpression(createPath("2", "fk"), BinaryOperator.EQUAL, createPath("0", "k")),
			new ComparativeExpression(createPath("1", "fk"), BinaryOperator.EQUAL, createPath("2", "k")));
		final ObjectCreation transformation = new ObjectCreation();
		...
		sopremoPlan.getOutputOperator(0).setInputs(join);
		for(int i = 0; i<=2; i++){
			sopremoPlan.getInput(i).
			addObject("k", 1, "fk", 2).
			addObject("k", 2, "fk", 3).
			addObject("k", 3, "fk", 1);
		}
		sopremoPlan.getExpectedOutput(0).
			addObject("k1", 1, "k2", 2, "k3", 3).
			addObject("k1", 2, "k2", 3, "k3", 1).
			addObject("k1", 3, "k2", 1, "k3", 2);
	...
	public void shouldFindTriangleThroughJoin() {
		...
		final AndExpression condition = new AndExpression(
			new ComparativeExpression(createPath("1", "fk"), BinaryOperator.EQUAL, createPath("2", "fk")),
	...
	public void shouldFindAlignedTrianglesThroughJoin() {
		...
		final AndExpression condition = new AndExpression(
			new ComparativeExpression(createPath("0", "t"), BinaryOperator.EQUAL, createPath("1", "s")),
			new ComparativeExpression(createPath("1", "t"), BinaryOperator.EQUAL, createPath("2", "s")),
			new ComparativeExpression(createPath("2", "t"), BinaryOperator.EQUAL, createPath("0", "s")),
			new ComparativeExpression(createPath("0", "t"), BinaryOperator.EQUAL, createPath("3", "s")),
			new ComparativeExpression(createPath("3", "t"), BinaryOperator.EQUAL, createPath("4", "s")),
			new ComparativeExpression(createPath("4", "t"), BinaryOperator.EQUAL, createPath("0", "s")),
			new ComparativeExpression(createPath("2", "s"), BinaryOperator.NOT_EQUAL, createPath("4", "s")));
		final ObjectCreation transformation = new ObjectCreation();
	...
	public void shouldPerformLeftOuterJoin2() {
		...
		sopremoPlan.getOutputOperator(0).setInputs(join);
		sopremoPlan.getInput(0).
			addObject("volume", 1234, "date", "2011-01-01").
			addObject("volume", 1234, "date", "2011-01-02").
			addObject("volume", 1234, "date", "2011-01-03");
		sopremoPlan.getInput(1).
			addObject("count", 3, "date", "2011-01-01");
		sopremoPlan.
			getExpectedOutput(0).
			addObject("x2_count", 3, "x1_volume", 1234, "date", "2011-01-01").
			addObject("x1_volume", 1234, "date", "2011-01-02").
