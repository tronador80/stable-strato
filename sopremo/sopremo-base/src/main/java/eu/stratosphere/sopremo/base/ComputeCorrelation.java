...
//					mean_y = y;
//				} else {
//					// probability of the already computed values
//					double p = Double.valueOf(i) / (i + 1);
//					// deviation of the mean x-E(x)
//					double delta_x = x - mean_x;
//					double delta_y = y - mean_y;
//
//					// deviation presenting by variance of X (E(x-E(x)))²=(X -
//					// µ)²/n,
//					// the standard deviation s (sigma) is the square root of
//					// the variance(X - µ)²
//					// Approaching the variance
//					sum_sq_x += delta_x * delta_x * p;
//					sum_sq_y += delta_y * delta_y * p;
//					// correct the previous sum of [x-E(x)]*[y-E(y)]
//					sum_coproduct += delta_x * delta_y * p;
//
//					// expected value corrected with current deviation
//					// considering of the probability
//					mean_x += delta_x / (i + 1);
//					mean_y += delta_y / (i + 1);
//				}
//				i++;
//			}
//
//			// the standard deviation s =sqrt((X - µ)²/n)
//			double pop_sd_x = Math.sqrt(sum_sq_x / i);
//			double pop_sd_y = Math.sqrt(sum_sq_y / i);
//			// covariance
//			double cov_x_y = sum_coproduct / i;
