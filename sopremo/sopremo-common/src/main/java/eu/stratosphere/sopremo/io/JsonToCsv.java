...
public class JsonToCsv {
	...
	public static FileDataSink convert(final String sourceFile, final JsonToCsv jsonToCsv,
		...
		SopremoUtil.setObject(jsonToString.getParameters(), SopremoUtil.CONTEXT, jsonToCsv.getContext());
		SopremoUtil.setObject(jsonToString.getParameters(), "extractionExpressions",
			jsonToCsv.getExtractionExpressions());
	...
	public static class JsonToString extends MapStub {
		...
		public void open(final Configuration parameters) throws Exception {
			...
			this.context = (EvaluationContext) SopremoUtil.getObject(parameters, "context", null);
			this.extractionExpressions =
				(List<EvaluationExpression>) SopremoUtil.getObject(parameters, "extractionExpressions", null);
		...
		public void map(final PactRecord record, final Collector<PactRecord> out) throws Exception {
			...
			this.node = this.schema.recordToJson(record);
