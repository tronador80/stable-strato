...
public class InputFileIterator implements Iterator<PactRecord>, Closeable {
	...
	private PactRecord nextRecord = NOT_LOADED;

	private static final PactRecord NO_MORE_PAIR = new PactRecord(), NOT_LOADED = new PactRecord();
