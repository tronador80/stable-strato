...
public class PactRecordComparatorFactory implements TypeComparatorFactory<PactRecord>
{
	...
	/* (non-Javadoc)
	 * @see eu.stratosphere.pact.common.generic.types.TypeComparatorFactory#createComparator(eu.stratosphere.nephele.configuration.Configuration, java.lang.ClassLoader)
	 */
	@Override
	public PactRecordComparator createComparator(Configuration config, ClassLoader cl)
