...
public final class PactConfigConstants {
	...
	/**
	 * The key for the config parameter defining whether the PACT runtime will use the Nephele multicast
	 * feature for its BROADCAST shipping strategy.
	 */
	public static final String USE_NEPHELE_MULTICAST_KEY = "pact.runtime.multicast";
	...
	/**
	 * The default setting for the Nephele multicast support.
	 */
	public static final boolean  DEFAULT_USE_NEPHELE_MULTICAST = false;
