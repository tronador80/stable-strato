...
/**
 * This class provides an interface for compressing byte-buffers with the native bzip2 library
 * http://www.bzip.org/
 * 
 * @author akli
 */
public class Bzip2Compressor extends AbstractCompressor {
	...
	Bzip2Compressor(final CompressionBufferProvider bufferProvider) {
