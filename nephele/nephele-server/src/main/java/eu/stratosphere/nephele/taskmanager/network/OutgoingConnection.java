...
final class OutgoingConnection {
	 ...
	 */
	OutgoingConnection(RemoteReceiver remoteReceiver, OutgoingConnectionThread connectionThread,
	 ...
	 */
	void queueEnvelope(TransferEnvelope transferEnvelope) {
	 ...
	 */
	void reportConnectionProblem(IOException ioe) {
	 ...
	 */
	void reportTransmissionProblem(IOException ioe) {
	 ...
	 */
	int getNumberOfQueuedEnvelopesFromChannel(final ChannelID sourceChannelID) {
	 ...
	 */
	void dropAllQueuedEnvelopesFromChannel(final ChannelID sourceChannelID) {
	 ...
	 */
	int getNumberOfQueuedWriteBuffers() {
