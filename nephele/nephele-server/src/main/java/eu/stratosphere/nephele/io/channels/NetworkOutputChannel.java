...
public final class NetworkOutputChannel<T extends Record> extends AbstractOutputChannel<T> {

	public NetworkOutputChannel(final OutputGate<T> outputGate, final int channelIndex, final ChannelID channelID,
