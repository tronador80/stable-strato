...
static jfieldID SnappyCompressor_uncompressedDataBuffer;
static jfieldID SnappyCompressor_uncompressedDataBufferLength;
...
JNIEXPORT void JNICALL Java_eu_stratosphere_nephele_io_compression_library_snappy_SnappyCompressor_initIDs (JNIEnv *env, jclass class){
	...
	SnappyCompressor_compressedDataBuffer = (*env)->GetFieldID(env, class, "compressedDataBuffer", "Ljava/nio/ByteBuffer;");
	SnappyCompressor_compressedDataBufferLength = (*env)->GetFieldID(env, class, "compressedDataBufferLength", "I");
