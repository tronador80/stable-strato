...
public abstract class AbstractJobVertex implements KryoSerializable {
	...
	/**
	 * The default value for allowing spanning records.
	 */
	private static final boolean DEFAULT_ALLOW_SPANNING_RECORDS = true;
	...
	public void connectTo(final AbstractJobVertex vertex) throws JobGraphDefinitionException {
		this.connectTo(vertex, null, null, -1, -1, DistributionPattern.BIPARTITE, DEFAULT_ALLOW_SPANNING_RECORDS);
	}
	...
	public void connectTo(final AbstractJobVertex vertex, final int indexOfOutputGate, final int indexOfInputGate)
		...
		this.connectTo(vertex, null, null, indexOfOutputGate, indexOfInputGate, DistributionPattern.BIPARTITE,
			DEFAULT_ALLOW_SPANNING_RECORDS);
	}
